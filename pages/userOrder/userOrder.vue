<template>
	<view>
				...
				<view class="proRow">
					<view class="item">
						<view class="fs12 flexRowBetween mgb10">
							<view class="color6">交易时间：2020-03-27</view>
							<view class="red">已付款</view>
						</view>
						<view class="flexRowBetween">
							<view class="pic">
								<image src="../../static/images/the-ordert-img.png" mode=""></image>
							</view>
							<view class="infor">
								<view class="avoidOverflow2 fs14">美味的鸡蛋饼</view>
								<view class=" fs12 color6">200g</view>
								<view class="B-price flexRowBetween">
									<view class="price fs15 ftw">138</view>
									<view class="fs13">×1</view>
								</view>
							</view>
						</view>
						<view class="borderB1 mgt15"></view>
						<view class="pdtb15 borderB1 fs12 color6">
						...
						<view class="mgt15 flexRowBetween">
							<view class="">核销码：526351221</view>
							<view class="hxEwm"  @click="hxEwmShow"><image src="../../static/images/invite-codel-img1.png" mode=""></image></view>
						</view>
					</view>
					<view class="item">
						<view class="fs12 flexRowBetween mgb10">
							<view class="color6">交易时间：2020-03-27</view>
							<view class="red">已预约</view>
						</view>
						<view class="flexRowBetween">
							<view class="pic">
								<image src="../../static/images/the-ordert-img.png" mode=""></image>
						...
						<view class="pdtb15 borderB1 fs12 color6">
							<view class="iconText flex">
								<view class="sIcon"><image src="../../static/images/confirml-icon1.png" mode=""></image></view>
								<view class="sText">商家地址：雁塔区长安中路金莎国际广场4楼</view>
							</view>
							<view class="iconText flex">
								<view class="sIcon"><image src="../../static/images/confirml-icon2.png" mode=""></image></view>
								<view class="sText">商家电话：029-23562312</view>
							</view>
							<view class="iconText flex">
								<view class="sIcon"><image src="../../static/images/confirml-icon2.1.png" mode=""></image></view>
								<view class="sText">预约日期：2020年03月27日</view>
							</view>
						</view>
						<view class="mgt15 flexRowBetween">
							<view class="">核销码：526351221</view>
					...
					<view class="item">
						...
						<view class="mgt15 flexRowBetween">
							<view style="text-decoration: line-through;">核销码：526351221</view>
							<view class="hxEwm"  @click="hxEwmShow"><image src="../../static/images/invite-codel-img1.png" mode=""></image></view>
						</view>
					</view>
					<view class="item">
		...
		<view class="hxEwmShow" v-show="is_hxEwmShow">
			<view><image class="ewm" src="../../static/images/invite-codel-img1.png" mode=""></image></view>
