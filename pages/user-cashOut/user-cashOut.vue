	...
	<view>
		<view style="padding: 70rpx 10%;">
			<view class="flexColumn center mgb30">
				<view class="icon" style="width:140rpx; height: 140rpx;">
					<image src="../../static/images/withdrawall-icon1.png" mode=""></image>
				</view>
			...
			<view class="fs12">
				<view class="flexCenter mgt20">
					<view style="width: 30rpx;height: 30rpx;">
						<image src="../../static/images/withdrawall-icon.png" mode=""></image>
					</view>
					<view class="color6 mgl5">满{{limit}}元即可提现</view>
				</view>
				<view class="red mgt10 center">
		...
		<view class="txAlertShow center whiteBj radius10" v-show="is_txAlertShow">
			...
			<view class="fs12 pdlr4 pdt15 pdb15 borderB1">
				...
				<view class="red mgt10 center">{{labelData.description}}</view>
			</view>
			<view class="flexRowBetween">
				<view style="width: 50%; height: 100rpx;line-height: 100rpx;box-sizing: border-box;border-right: 1px solid #eee;"
				 @click="txAlertShow">取消</view>
...
<script>
	export default {
		...
		onLoad() {
			...
			self.$Utils.loadAll(['getUserInfoData','getLimit','getLabelData'], self);
			/* const callback = (res) => {
		...
		methods: {
			...
			getLimit() {
				...
				const callback = (res) => {
					...
					self.$Utils.finishFunc('getLimit');
			
				};
				self.$apis.getLimit(postData, callback);
			},
